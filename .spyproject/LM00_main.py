...
#Seperating out dependent and independent variables
...
regr.fit(X, Y)
regr.score(X, Y)  #R2 
# r^2= 89% (goodness of fit) 89% of the variation in stock price is because of umenployement and interest rate. 
print('Intercept: \n', regr.intercept_)
print('Coefficients: \n', regr.coef_)
