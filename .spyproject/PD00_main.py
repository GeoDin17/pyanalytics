...
mtcarsDF.head(3)
mtcarsDF.tail(4)
help(mtcarsDF.describe)
mtcarsDF.columns
mtcarsDF.dtypes
mtcarsDF.describe(include=[np.number])
mtcarsDF.describe()
...
mtcars.size
mtcars.ndim
mtcars.axes #row names and column names 
mtcars.values
...
mtcarsDF.filter(regex = '[gGaw]')  #small or big G or a in the column name
...
mtcarsDF.sort_values(by='wt').plot(x='wt', y='mpg')
